...
function EmptyState() {
	...
	return (
		<div className="empty">
			...
			<p>
				grotto is a local assistant. It reads from your indexed notes and answers
				with citations back to the source.
			</p>
			{configError ? (
				<p>
					<strong>No config found.</strong> Run <code>grotto init</code> in your
				...
				<p>
					<strong>{sources!.total}</strong> chunks from{' '}
					<strong>{sources!.sources.length}</strong> file
